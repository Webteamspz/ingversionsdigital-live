const projectsData = {
  ...
  projects: [
    ...
    },
    {
      ...
      beforeImage: "/assets/project/beforerapidradio.png?v=2",
      afterImage: "/assets/project/afterrapidradio.png?v=2",
    ...
    },
    {
      ...
      title: "Safety Gear",
      type: "Shopify",
      image: "/assets/project/safetgear.webp?v=2",
    ...
    },
    {
      ...
      beforeImage: "/assets/project/Beforenecklace.png?v=2", 
      afterImage: "/assets/project/afternecklace.png?v=2",
    ...
    },
    {
      ...
      title: "Bijou Build",
      type: "A/B Testing",
      beforeImage: "/assets/project/beforebijou.png?v=2", 
      afterImage: "/assets/project/afterbijou.png?v=2",
    ...
    },
    {
      ...
      title: "Belare Home ",
      type: "A/B Testing",
      beforeImage: "/assets/project/beforebelare.png?v=2", 
      afterImage: "/assets/project/afterbelare.png?v=2",
      ...
      title: "UltimaPeak ",
      type: "A/B Testing",
      beforeImage: "/assets/project/beforeultimapeak.png?v=2", 
      afterImage: "/assets/project/afterultimapeak.png?v=2",
      ...
      type: "A/B Testing",
      beforeImage: "/assets/project/beforefactoryweights.png?v=2", 
      afterImage: "/assets/project/afterfactoryweights.png?v=2",
